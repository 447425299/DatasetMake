...
extern std::string  filepath;  //csh


void handleKey(char k);

extern int staticPattern64[4096][2];
extern int staticPattern32[1024][2];
extern int staticPattern56[3136][2];


extern int staticPattern16[256][2];
...
//搜索patchsize_change8就是要改的项目
// #define patternNum 1024       //patchsize_change8
#define patternNum 8       //patchsize_change8
#define patternPatchNum 1024

#define patternP staticPattern[8]
// #define patternP staticPattern32 //patchsize_change8 //最大可以弄５６的ｐａｔｃｈ　小于６０　且为８的倍数
#define patternPatch staticPattern32 //patchsize_change8

#define patternPadding 2 //patchsize_change8
// #define patternPadding 16 //patchsize_change8
#define patternPaddingPatch 16 //change8

#define PatchSize 32 //change8
//记得还有一个 MAX_RES_PER_POINT　变量需要改


//标记有　尝试减去约束　的地方是有可能产生段错误的地方
//当优化用ｐａｔｃｈ　和生成ｐａｔｃｈ不一致时可能还有问题(color16)，尝试解决之
