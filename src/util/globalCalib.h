...
namespace dso
{
	...
	extern float wM3G;
	extern float hM3G;
	extern  std::vector<float> Normtowrite; //位姿的摸
	extern  std::vector<float> Costtowrite; //输出patch的cost
	extern  std::vector<float> Costallwrite; //输出patch的suoyou cost
	extern  std::vector<std::string> So_prt; //输出名字
	extern  std::vector<std::string> Sp_prt; //输出名字
