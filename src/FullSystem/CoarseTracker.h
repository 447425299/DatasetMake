...
public:
	...
	bool trackNewestCoarse(//进行投影计算,计算出投影误差
	...
	int refFrameID;//并没有与太大用 应该在其他模式下有用吧
...
private:
	...
	Vec6 calcRes(int lvl, const SE3 &refToNew, AffLight aff_g2l, float cutoffTH);//计算投影误差
