...
enum ImmaturePointStatus {//IPS  代表 ImmaturePointStatus
...
public:
	...
	Mat22f gradH;//TODO 这是什么意思
	Vec2f gradH_ev;
	Mat22f gradH_eig;
	float energyTH;//判断是否为坏点的量	
	float u,v;
	FrameHessian* host;
	int idxInImmaturePoints;

	float quality;//与次优的比,也就是最优值的地位,是否明显其他
